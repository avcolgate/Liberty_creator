...
OPENSTA, LIBRARY, LEF, VERILOG, NETLIST, RESULTS, TCL = data_init(path_opensta, path_input_lib, path_lef, path_verilog,
                                                                  path_netlist, dir_results, dir_tcl)
...
pin_transitions = get_net_transition(LIBRARY.path)

make_template(module_name, module_inputs, clocks, pin_transitions, LIBRARY.path, TCL.path, RESULTS.path, NETLIST.path)
